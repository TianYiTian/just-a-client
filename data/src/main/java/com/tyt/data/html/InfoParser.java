...
//    private static Handler sHandler;
    ...
    public void parse(int channel,int area,int category,int year,int sort,int page,int whichpage)throws IOException{
    ...
    public void parse(final String channel, final String area, final String category, final String year, final String sort, final int page,final int whichpage) throws IOException{
        if (!isLoading) {
            isLoading = true;
